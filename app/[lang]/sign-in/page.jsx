...
import { authClient, signInWithEmail } from "../../../lib/auth-client.js"; //import the auth client
import Link from 'next/link.js';
import VerifyEmail from '../../../components/signin/verifyEmail.jsx';
import { signInSchema } from '../../../lib/validations.js';
...
const handleEmailPasswordLogin = async (e) => {
  ...
  try {
    ...
    if (error.message === "EMAIL_NOT_VERIFIED" || error.status === 403) {
      setRequireEmailVerification(() => true)
    } else {
      // Handle other errors (you can add toast notification here)
